...
$GLOBALS['TL_LANG']['tl_syncCto_clients_syncFrom']['tl_files_check']                    = array('\'tl-files\' überschreiben', 'Wählen Sie diese Option, wenn Sie die \'tl-files\' Tablle synchronisieren wollen.');
