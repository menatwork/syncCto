 ...
 * Legends
 */
$GLOBALS['TL_LANG']['tl_user']['syncCto_legend']        = 'SyncCto - Client permissions';
$GLOBALS['TL_LANG']['tl_user']['syncCto_tables_legend'] = 'SyncCto - Allowed tables';

/**
 * Fields
 */
$GLOBALS['TL_LANG']['tl_user']['syncCto_clients']               = [
    'Allowed clients',
    'Here you can grant access to one or more clients.'
];
$GLOBALS['TL_LANG']['tl_user']['syncCto_clients_p']             = [
    'Client permissions',
    'Here you can define the client permissions.'
];
$GLOBALS['TL_LANG']['tl_user']['syncCto_sync_options']          = [
    'Allowed file operations',
    'Here you can choose allowed file operations'
];
$GLOBALS['TL_LANG']['tl_user']['syncCto_tables']                = [
    'Allowed tables',
    'Here you can grant access to the database tables.'
];
$GLOBALS['TL_LANG']['tl_user']['syncCto_useTranslatedNames']    = [
...
$GLOBALS['TL_LANG']['tl_user']['syncCto_force_dbafs_overwrite'] = [
    'Force DBAFS overwrite',
    'When enabled the db table tl_files for the dbafs will be overwritten.'
];
$GLOBALS['TL_LANG']['tl_user']['syncCto_hide_auto_sync']      = [
