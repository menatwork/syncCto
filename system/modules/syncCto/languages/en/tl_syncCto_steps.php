...
$GLOBALS['TL_LANG']['tl_syncCto_sync']['step_1_show']['description_1']      = 'Getting system check from client.';
...
$GLOBALS['TL_LANG']['tl_syncCto_sync']['step_3']['description_3']           = 'Fragmenting large files.';
$GLOBALS['TL_LANG']['tl_syncCto_sync']['step_3']['description_4']           = 'Transferred large files.';
$GLOBALS['TL_LANG']['tl_syncCto_sync']['step_3']['description_5']           = 'Assemble large files.';
$GLOBALS['TL_LANG']['tl_syncCto_sync']['step_3']['description_7']           = '%s of %s large file(s) have been fragmented.';
