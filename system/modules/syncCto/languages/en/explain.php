...
$GLOBALS['TL_LANG']['XPL']['folder_blacklist']['1']         = array('Wildcards at the end of a path', 'Jeder Eintrag wird automatisch am Ende mit einem * versehen. Bei dem Platzhalter "assets/css", würde syncCto auch den Ordner unter "assets/css3pie" ignorieren. Daher sollte nach jedem explizitem Ordner ein "/" angeben werden.');
