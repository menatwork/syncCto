...
$GLOBALS['TL_LANG']['XPL']['folder_blacklist']['0']         = array('Wildcards at the beginning of a path', 'A TL_ROOT-prefix will be added to each entry. When adding the entry "assets/css", the folder "TL_ROOT/assest/css" will be ignored but not the folder "system/modules/example-extension/assets/css/".');
$GLOBALS['TL_LANG']['XPL']['folder_blacklist']['1']         = array('Wildcards at the end of a path','A * wildcard will be added as a default suffix for every entry. With the entry "assets/css", syncCto will also ignore the folder "asssets/css3pe". If you just want to ignore a single folder, please make sure to put a "/" at the end of the entry.' );
