...
$GLOBALS['TL_LANG']['tl_syncCto_backup_file']['user_files']                     = array('Dateiverwaltung (files)', 'Wählen Sie bitte aus, ob die persönlichen Dateien gesichert werden sollen.');
 ...
 * List
 */
$GLOBALS['TL_LANG']['tl_syncCto_backup_file']['step1']                          = 'Contao-Installation / Dateiverwaltung sichern.';
