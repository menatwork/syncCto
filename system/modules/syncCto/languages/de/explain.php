...
$GLOBALS['TL_LANG']['XPL']['folder_blacklist']['3']['0'] = 'Beispiel 2: Fortlaufende Nummerierung';
$GLOBALS['TL_LANG']['XPL']['folder_blacklist']['3']['1'] = 'Ordner mit fortlaufender Nummerierung können mit dem * Selektor ignoriert werden. Zum Beispiel Backupverzeichnisse wie "backup/file_" oder "backup/db_" werden dadurch ignoriert, sofern sie mit "file_" oder "db_" anfangen.';
