...
$GLOBALS['TL_DCA']['tl_synccto_clients'] = array(
    ...
    'config' => array(
        ...
        'onload_callback' => array(
            array('SyncCtoCallback', 'checkPermissionClient'),
            array('SyncCtoCallback', 'checkPermissionClientCreate'),
        ),
    ),
    // List
    'list' => array(
        ...
        'operations' => array(
            'edit' => array(
                ...
                'href' => 'act=edit',
                'icon' => 'edit.gif',
                'button_callback' => array('SyncCtoCallback', 'checkPermission_client_edit'),
            ),
            'copy' => array(
                'label' => &$GLOBALS['TL_LANG']['tl_synccto_clients']['copy'],
                'href' => 'act=copy',
                'icon' => 'copy.gif',
                'button_callback' => array('SyncCtoCallback', 'checkPermission_client_copy'),
            ),
            'delete' => array(
                ...
                'button_callback' => array('SyncCtoCallback', 'checkPermission_client_delete'),
            ),
            'show' => array(
                'label' => &$GLOBALS['TL_LANG']['tl_synccto_clients']['show'],
                'href' => 'act=show',
                'icon' => 'show.gif',
                'button_callback' => array('SyncCtoCallback', 'checkPermission_client_show'),
            ),
            'syncFrom' => array(
                ...
                'button_callback' => array('SyncCtoCallback', 'checkPermission_client_syncFrom'),
            ),
            'syncTo' => array(
                ...
                'button_callback' => array('SyncCtoCallback', 'checkPermission_client_syncTo'),
            ),
        )
    ),
    // Palettes
