...
class SyncCtoSimpleHtmlDomHelper
{
...
class SyncCtoSimpleHtmlDom
{
    ...
    protected function prepare($str, $lowercase=true)
    {
        ...
        $this->root = new SyncCtoSimpleHtmlNode($this);
        $this->root->tag = 'root';
    ...
    protected function parse()
    {
        ...
        // text
        $node = new SyncCtoSimpleHtmlNode($this);
        ++$this->cursor;
