...
class SyncCtoModuleCheck extends BackendModule
{
    ...
    public function checkPhpConfiguration()
    {
        ...
        $return .= '<tr>';
        $return .= '<th>' . $GLOBALS['TL_LANG']['syncCto_check']['parameter'] . '</th>';
        $return .= '<th class="dot" style="width:1%;">•</th>';
        $return .= '<th>' . $GLOBALS['TL_LANG']['syncCto_check']['value'] . '</th>';
        $return .= '<th>' . $GLOBALS['TL_LANG']['syncCto_check']['description'] . '</th>';
        $return .= '</tr>';
        ...
        $return .= '<td>' . $GLOBALS['TL_LANG']['syncCto_check']['safemode'][0] . '</td>';
        $return .= '<td class="dot">' . ($ok ? '&nbsp;' : '•') . '</td>';
        $return .= '<td class="value">' . ($safe_mode ? $GLOBALS['TL_LANG']['syncCto_check']['on'] : $GLOBALS['TL_LANG']['syncCto_check']['off']) . '</td>';
        $return .= '<td>' . $GLOBALS['TL_LANG']['syncCto_check']['safemode'][1] . '</td>';
        $return .= '</tr>';
        ...
        $return .= '<tr class="' . ($ok ? 'ok' : 'warning') . '">';
        $return .= '<td>' . $GLOBALS['TL_LANG']['syncCto_check']['met'][0] . '</td>';
        $return .= '<td class="dot">' . ($ok ? '&nbsp;' : '•') . '</td>';
        $return .= '<td class="value">' . $max_execution_time . '</td>';
        $return .= '<td>' . $GLOBALS['TL_LANG']['syncCto_check']['met'][1] . '</td>';
        $return .= '</tr>';
        ...
        $return .= '<tr class="' . ($ok ? 'ok' : 'warning') . '">';
        $return .= '<td>' . $GLOBALS['TL_LANG']['syncCto_check']['memory_limit'][0] . '</td>';
        $return .= '<td class="dot">' . ($ok ? '&nbsp;' : '•') . '</td>';
        $return .= '<td class="value">' . $memory_limit . '</td>';
        $return .= '<td>' . $GLOBALS['TL_LANG']['syncCto_check']['memory_limit'][1] . '</td>';
        $return .= '</tr>';
        ...
        $return .= '<tr class="' . ($ok ? 'ok' : 'warning') . '">';
        $return .= '<td>' . $GLOBALS['TL_LANG']['syncCto_check']['register_globals'][0] . '</td>';
        $return .= '<td class="dot">' . ($ok ? '&nbsp;' : '•') . '</td>';
        $return .= '<td class="value">' . ($register_globals ? $GLOBALS['TL_LANG']['syncCto_check']['on'] : $GLOBALS['TL_LANG']['syncCto_check']['off']) . '</td>';
        $return .= '<td>' . $GLOBALS['TL_LANG']['syncCto_check']['register_globals'][1] . '</td>';
        $return .= '</tr>';
        ...
        $return .= '<tr class="' . ($ok ? 'ok' : 'warning') . '">';
        $return .= '<td>' . $GLOBALS['TL_LANG']['syncCto_check']['file_uploads'][0] . '</td>';
        $return .= '<td class="dot">' . ($ok ? '&nbsp;' : '•') . '</td>';
        $return .= '<td class="value">' . ($file_uploads ? $GLOBALS['TL_LANG']['syncCto_check']['on'] : $GLOBALS['TL_LANG']['syncCto_check']['off']) . '</td>';
        $return .= '<td>' . $GLOBALS['TL_LANG']['syncCto_check']['file_uploads'][1] . '</td>';
        $return .= '</tr>';
        ...
        $return .= '<tr class="' . ($ok ? 'ok' : 'warning') . '">';
        $return .= '<td>' . $GLOBALS['TL_LANG']['syncCto_check']['umf'][0] . '</td>';
        $return .= '<td class="dot">' . ($ok ? '&nbsp;' : '•') . '</td>';
        $return .= '<td class="value">' . $upload_max_filesize . '</td>';
        $return .= '<td>' . $GLOBALS['TL_LANG']['syncCto_check']['umf'][1] . '</td>';
        $return .= '</tr>';
        ...
        $return .= '<tr class="' . ($ok ? 'ok' : 'warning') . '">';
        $return .= '<td>' . $GLOBALS['TL_LANG']['syncCto_check']['pms'][0] . '</td>';
        $return .= '<td class="dot">' . ($ok ? '&nbsp;' : '•') . '</td>';
        ...
        $return .= '<tr class="' . ($ok ? 'ok' : 'warning') . '">';
        $return .= '<td>' . $GLOBALS['TL_LANG']['syncCto_check']['mit'][0] . '</td>';
        $return .= '<td class="dot">' . ($ok ? '&nbsp;' : '•') . '</td>';
        ...
        $return .= '<tr class="' . ($ok ? 'ok' : 'warning') . '">';
        $return .= '<td>' . $GLOBALS['TL_LANG']['syncCto_check']['dst'][0] . '</td>';
        $return .= '<td class="dot">' . ($ok ? '&nbsp;' : '•') . '</td>';
        ...
        $ok = ($fsockopen == true);
        $return .= '<tr class="' . ($ok ? 'ok' : 'warning') . '">';
        $return .= '<td>' . $GLOBALS['TL_LANG']['syncCto_check']['fsocket'][0] . '</td>';
        $return .= '<td class="dot">' . ($ok ? '&nbsp;' : '•') . '</td>';
        ...
        $return .= '<tr class="' . ($ok ? 'ok' : 'warning') . '">';
        $return .= '<td>' . $GLOBALS['TL_LANG']['syncCto_check']['fopen'][0] . '</td>';
        $return .= '<td class="dot">' . ($ok ? '&nbsp;' : '•') . '</td>';
        $return .= '<td class="value">' . ($allow_url_fopen ? $GLOBALS['TL_LANG']['syncCto_check']['on'] : $GLOBALS['TL_LANG']['syncCto_check']['off']) . '</td>';
        $return .= '<td>' . $GLOBALS['TL_LANG']['syncCto_check']['fopen'][1] . '</td>';
        $return .= '</tr>';
        ...
        $ok = ($zip_archive == true);
        $return .= '<tr class="' . ($ok ? 'ok' : 'warning') . '">';
        $return .= '<td>' . $GLOBALS['TL_LANG']['syncCto_check']['zip_archive'][0] . '</td>';
        $return .= '<td class="dot">' . ($ok ? '&nbsp;' : '•') . '</td>';
