...
class Backup extends BackendModule
{
    ...
    /**
     * @var \SyncCto\Contao\Sync\StepPool
     */
    ...
    public function __construct(DataContainer $objDc = null)
    {
        ...
        else if (Input::get("table") != "" && Input::get("act") != "")
        {
        ...
        try
        {
            switch ($this->intStep)
            {
                ...
                case 2:
                    ...
                    Dbafs::addResource(Helper::getInstance()->standardizePath($GLOBALS['SYC_PATH']['db'], $this->objStepPool->zipname));
        ...
        try
        {
            switch ($this->intStep)
            {
                ...
                case 2:
                    ...
                    Dbafs::addResource(Helper::getInstance()->standardizePath($GLOBALS['SYC_PATH']['file'], $this->objStepPool->zipname));
