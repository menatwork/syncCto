 ...
 */
class CtoCodifyengineImpl_Blowfish extends CtoCodifyengineAbstract
{
    /* -------------------------------------------------------------------------
     ...
     * Vars
     */
    protected static $strName = "Blowfish";
    protected $cbc;
     ...
     * Singelton Pattern
     * 
     * @return CtoCodifyengineAbstract 
     */
    public static function getInstance()
    {
        if (self::$instance == null)
            self::$instance = new CtoCodifyengineImpl_Blowfish();
    ...
    public function setKey($strKey)
    {
        ...
        $this->pbox = $this->pboxBase;
        $this->sbox0 = $this->sbox0Base;
        $this->sbox1 = $this->sbox1Base;
        $this->sbox2 = $this->sbox2Base;
    ...
    public function Decrypt($text)
    {
        ...
        return trim($output);
        //return html_entity_decode(trim($output));
    }
