 ...
 * Engine
 */
$GLOBALS['TL_LANG']['ctoCom']['codifyengine']["Empty"] = "Keine Verschlüsselung";
...
$GLOBALS['TL_LANG']['ERR']['not_a_engine'] = "Die ausgewählte Verschlüsselungs Engine ist nicht von der Abstracten Standart Engine abgeleitet.";
?>